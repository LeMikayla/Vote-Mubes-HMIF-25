  ...
  const handleLogin = async (e) => {
    ...
    if (result.success) {
      ...
      if (userRole === "admin") {
        ...
        // Gunakan path lengkap agar router tidak bingung
      ...
      // Gunakan result.error karena di authContext kamu melempar "error" bukan "message"
      toast.error(result.error || "Gagal login. Silakan coba lagi.");
    }
  };
