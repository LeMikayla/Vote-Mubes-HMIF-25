// Ini adalah komponen "Scrolls" yang lama
  ...
  return (
    <div className="flex items-center justify-center gap-0 filter drop-shadow-md">
      ...
      <div className="relative w-3 h-9 -right-1.5">
        <svg viewBox="0 0 40 120" className="absolute top-0 left-[3.125px] w-full h-full" preserveAspectRatio="none">
          <path d="M30 0 Q10 60 30 120 L10 120 Q0 60 10 0 Z" fill="#F4AB39" />
        </svg>
        <svg viewBox="0 0 40 120" className="absolute w-[70%] h-[70%] left-[1.875px] top-[5.3125px]" preserveAspectRatio="none">
          <path d="M30 0 Q10 60 30 120 L10 120 Q0 60 10 0 Z" fill="#F4AB39" />
        </svg>
      </div>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/paper.png')", // Pastikan path asset benar
